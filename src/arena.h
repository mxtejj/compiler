...
#define push_struct(arena, T)      (T *)arena_push_((arena), sizeof(T), false)
#define push_struct_nz(arena, T)   (T *)arena_push_((arena), sizeof(T), true)
#define push_array(arena, T, n)    (T *)arena_push_((arena), sizeof(T) * (n), false)
#define push_array_nz(arena, T, n) (T *)arena_push_((arena), sizeof(T) * (n), true)
...
void  *arena_push_(Arena *arena, u64 size, b32 non_zero);
